...
export const HOT_EVENTS = [
  ...
  },
  {
    ...
    queries: [
      '"Mozart 100" 2026 Salzburg ultramarathon results May',
      '"Mozart 100 by UTMB" 2026 Salzburg favoris plateau course',
      'Mozart 100 Autriche 23 mai 2026 resultats finishers',
    ],
    tags: ["Mozart 100", "ultra-trail", "UTMB World Series", "live"],
  },
  {
    ...
    queries: [
      ...
      'MUT UTMB 2026 George Afrique du Sud plateau favoris course',
      '"MUT by UTMB" 2026 South Africa finishers winner',
    ],
    tags: ["MUT", "Mountain Ultra Trail", "UTMB World Series", "Afrique du Sud", "live"],
  },
  {
    slug: "trail-100-andorra-by-utmb",
    name: "Trail 100 Andorra by UTMB",
    start: "2026-06-13",
    location: "Andorre",
    queries: [
      '"Trail 100 Andorra" "by UTMB" 2026 results Pyrenees',
      'Trail 100 Andorra UTMB 2026 vainqueur plateau favoris',
      '"Andorra 100K" 2026 Andorre 13 juin resultats finishers',
    ],
    tags: ["Trail 100 Andorra", "UTMB World Series", "Andorre", "Pyrenees", "live"],
  },
  {
    slug: "utmb-saint-jacques",
    name: "UTMB Saint-Jacques",
    start: "2026-06-13",
    location: "Saint-Jacques-de-Compostelle, Espagne",
    queries: [
      '"UTMB Saint Jacques" 2026 Compostela ultra Espagne resultats',
      'UTMB Saint-Jacques 2026 13 juin Compostelle favoris',
      '"Saint Jacques by UTMB" 2026 vainqueur finishers',
    ],
    tags: ["UTMB Saint-Jacques", "UTMB World Series", "Saint-Jacques", "Espagne", "live"],
  },
  {
