Write-Host "Correction des fichiers altitude-trail..." -ForegroundColor Green

Write-Host "Ecriture src\app\globals.css..."
$c = @'
...
'@
$c | Out-File -FilePath "src\app\globals.css" -Encoding utf8

Write-Host "Ecriture src\app\layout.tsx..."
$c = @'
...
'@
$c | Out-File -FilePath "src\app\layout.tsx" -Encoding utf8

Write-Host "Ecriture src\app\page.tsx..."
$c = @'
...
'@
$c | Out-File -FilePath "src\app\page.tsx" -Encoding utf8

Write-Host "Ecriture src\app\courses\page.tsx..."
$c = @'
...
'@
$c | Out-File -FilePath "src\app\courses\page.tsx" -Encoding utf8

Write-Host "Ecriture src\app\categories\[slug]\page.tsx..."
$c = @'
...
'@
$c | Out-File -FilePath "src\app\categories\[slug]\page.tsx" -Encoding utf8

Write-Host "Ecriture src\app\articles\[slug]\page.tsx..."
$c = @'
...
'@
$c | Out-File -FilePath "src\app\articles\[slug]\page.tsx" -Encoding utf8

Write-Host "Ecriture src\app\contact\page.tsx..."
$c = @'
import Link from "next/link";
...
'@
$c | Out-File -FilePath "src\app\contact\page.tsx" -Encoding utf8

Write-Host "Ecriture src\components\layout\Footer.tsx..."
$c = @'
import Link from "next/link";
...
'@
$c | Out-File -FilePath "src\components\layout\Footer.tsx" -Encoding utf8

Write-Host "Ecriture src\components\layout\Header.tsx..."
$c = @'
"use client";
import Link from "next/link";
...
'@
$c | Out-File -FilePath "src\components\layout\Header.tsx" -Encoding utf8

Write-Host "Ecriture src\components\ui\ArticleCard.tsx..."
$c = @'
import Link from "next/link";
import Image from "next/image";
...
'@
$c | Out-File -FilePath "src\components\ui\ArticleCard.tsx" -Encoding utf8

Write-Host "Ecriture src\lib\data.ts..."
$c = @'
...
'@
$c | Out-File -FilePath "src\lib\data.ts" -Encoding utf8

Write-Host "Ecriture src\types\index.ts..."
$c = @'
...
'@
$c | Out-File -FilePath "src\types\index.ts" -Encoding utf8

Write-Host "Ecriture next.config.ts..."
$c = @'
...
'@
$c | Out-File -FilePath "next.config.ts" -Encoding utf8

Write-Host "Ecriture tailwind.config.ts..."
$c = @'
...
'@
$c | Out-File -FilePath "tailwind.config.ts" -Encoding utf8

Write-Host "Termine! Lance: npm run dev" -ForegroundColor Green