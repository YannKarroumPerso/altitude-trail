...
export const AUTHORS: Author[] = [
  {
    slug: "thomas-rouvier",
    name: "Thomas Rouvier",
    bio: "Coach trail et finisher UTMB, passionné de la préparation physique spécifique montagne.",
  ...
  },
  {
    slug: "claire-mercier",
    name: "Claire Mercier",
    bio: "Diététicienne du sport et ultra-traileuse, spécialisée dans la nutrition d'endurance.",
  ...
  },
  {
    slug: "marc-blanc",
    name: "Marc Blanc",
    bio: "Journaliste trail, couvre le circuit international depuis plus de dix ans.",
  ...
  },
  {
    slug: "yann-karroum",
    name: "Yann Karroum",
    bio: "Passionné et pratiquant de trail.",
    jobTitle: "Rédacteur",
