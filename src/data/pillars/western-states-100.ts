...
Toute la couverture éditoriale d'Altitude Trail sur le WSER est rassemblée ici : préviews du plateau élite américain et international, analyses tactiques (gestion des canyons, stratégie hydratation, ravitaillement Foresthill), résultats live, et décryptages institutionnels.`,
  ...
  palmares: [
    { year: 2025, men: "Caleb Olson (USA)", women: "Abby Hall (USA)", menTime: "14 h 11 min", womenTime: "16 h 37 min" },
    { year: 2024, men: "Jim Walmsley (USA)", women: "Katie Schide (USA)", menTime: "14 h 13 min 45 s", womenTime: "15 h 46 min 57 s" },
    { year: 2023, men: "Tom Evans (GBR)", women: "Courtney Dauwalter (USA)", menTime: "14 h 40 min", womenTime: "15 h 29 min (record)" },
    { year: 2022, men: "Adam Peterman (USA)", women: "Ruth Croft (NZL)", menTime: "15 h 13 min 48 s", womenTime: "17 h 21 min 30 s" },
    { year: 2021, men: "Jim Walmsley (USA)", women: "Beth Pascall (GBR)", menTime: "14 h 46 min", womenTime: "17 h 10 min 42 s" },
  ],
  glossary: [
  ...
  faq: [
    { question: "Comment se qualifier pour le Western States ?", answer: "Deux voies : la lottery (tirage au sort) après avoir bouclé une course qualifiante WSER pendant l'année, ou un Golden Ticket (podium sur une des courses qualificatives mondiales)." },
    { question: "Combien coûte l'inscription ?", answer: "525 USD pour 2026, plus frais de qualification et licence. Coût total avec voyage depuis l'Europe : 4 000 à 5 000 €." },
    { question: "Quel est le record ?", answer: "Jim Walmsley : 14 h 09 min (2022). Courtney Dauwalter : record féminin en 2023 (15 h 29 min)." },
