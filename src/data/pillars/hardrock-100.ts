...
export const hardrock100: PillarDossier = {
  ...
  intro: `Le Hardrock Hundred Mile Endurance Run, créé en 1992 à Silverton (Colorado), est l'ultra de montagne le plus exigeant des États-Unis. 160 km en boucle dans les San Juan Mountains, 10 000 mètres de dénivelé positif, et une altitude moyenne de 3 360 m culminant à 4 282 m au Handies Peak. La course se court fin juillet sous des conditions extrêmes : neige résiduelle aux passages les plus hauts, orages électriques quotidiens, hypothermie possible la nuit, mal aigu des montagnes garanti pour qui n'est pas acclimaté.

Le rituel mythique : embrasser le Hardrock, un bloc de quartz brut à Silverton, devant 200 spectateurs. La course alterne chaque année le sens (clockwise / counter-clockwise) et exige 48 h maximum. Le taux de finishers tourne autour de 60 %, l'un des plus faibles de tout le circuit mondial.
...
Toute la couverture Altitude Trail du Hardrock est rassemblée ici : préviews du plateau (souvent restreint, 145 dossards), analyses des stratégies acclimatation altitude, récits des cols mythiques (Grant Swamp Pass, Virginius Pass), et débats sur la durabilité environnementale dans cet écosystème alpin fragile.`,
  ...
  programme: [
    ...
    { label: "Jeudi 9 juillet", value: "Course briefing officiel, parcours détaillé selon sens de l'année" },
    { label: "Vendredi 10 juillet", value: "Départ 6 h heure des Rocheuses (14 h heure de Paris)" },
    { label: "Samedi 11 juillet", value: "Premières arrivées vers 8 h heure locale (16 h Paris)" },
    { label: "Dimanche 12 juillet", value: "Cut-off final à 6 h heure locale" },
  ],
  palmares: [
    { year: 2025, men: "Hannes Namberger (GER)", women: "Courtney Dauwalter (USA)", menTime: "21 h 25 min", womenTime: "26 h 14 min" },
    { year: 2024, men: "Ludovic Pommeret (FRA)", women: "Courtney Dauwalter (USA)", menTime: "21 h 33 min", womenTime: "25 h 51 min" },
    { year: 2023, men: "François D'Haene (FRA)", women: "Courtney Dauwalter (USA)", menTime: "21 h 45 min", womenTime: "26 h 14 min" },
    { year: 2022, men: "Kilian Jornet (ESP)", women: "Courtney Dauwalter (USA)", menTime: "21 h 36 min", womenTime: "26 h 44 min" },
    { year: 2021, men: "François D'Haene (FRA)", women: "Courtney Dauwalter (USA)", menTime: "21 h 45 min", womenTime: "26 h 51 min" },
  ],
  glossary: [
    ...
    { term: "Counter-clockwise / Clockwise", definition: "Le parcours alterne chaque année dans le sens horaire ou anti-horaire. Les sections techniques (Grant Swamp Pass, Virginius) changent donc d'orientation montée/descente." },
  ...
  faq: [
    ...
    { question: "Quel est le record ?", answer: "Kilian Jornet : 21 h 36 min (2022, sens counter-clockwise). Courtney Dauwalter : 25 h 51 min (2024)." },
  ...
  howToWatch: [
    ...
    { label: "Live blog Altitude Trail", description: "Coverage francophone Altitude Trail avec focus sur les coureurs français (D'Haene, Pommeret, Buisson...)" },
  ],
