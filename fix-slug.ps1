Write-Host "Fix des pages dynamiques..." -ForegroundColor Yellow
...
'@
$c | Out-File -LiteralPath "src\app\categories\[slug]\page.tsx" -Encoding utf8
...
'@
$c | Out-File -LiteralPath "src\app\articles\[slug]\page.tsx" -Encoding utf8

Write-Host "OK! Lance npm run dev" -ForegroundColor Green