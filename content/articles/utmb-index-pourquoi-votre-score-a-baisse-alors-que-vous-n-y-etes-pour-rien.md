---
slug: "utmb-index-en-baisse-pourquoi-votre-score-a-chute-sans-que-vous-ayez-couru"
title: "UTMB Index en baisse : pourquoi votre score a chuté sans que vous ayez couru"
excerpt: "Des milliers de coureurs ont vu leur UTMB Index reculer sans avoir disputé la moindre course. La cause : un algorithme que l'UTMB World Series recalibre en silence, avec des conséquences directes sur la qualification aux grandes épreuves du circuit."
category: "Actualités"
...
readTime: "5 min"
image: "/articles/utmb-index-en-baisse-pourquoi-votre-score-a-chute-sans-que-vous-ayez-couru-hero.jpg"
...
externalRefs:
  - { url: "https://www2.u-trail.com/utmb-index-pourquoi-votre-score-a-baisse-alors-que-vous-ny-etes-pour-rien/", label: "UTMB Index : pourquoi votre score a baissé alors que vous n" }
  - { url: "https://www.utmb.world", label: "UTMB World Series — site officiel" }
  - { url: "https://www.itra.run", label: "ITRA — International Trail Running Association" }
  - { url: "https://www.irunfar.com", label: "iRunFar — actualités trail et analyses de courses internationales" }
imagePrompt1: "Trail runner sitting on rocky alpine trail checking smartphone showing numeric score dashboard app, morning fog filling valley below, Chamonix Alps granite peaks backdrop, worn trail shoes, blue softshell jacket, soft golden hour backlight from the east"
imagePrompt2: "Dense crowd of trail runners at UTMB World Series race start line in mountain village at dawn, race bibs clearly visible, focused and tense expressions, technical running gear, spectators behind metal barriers, cool blue pre-dawn light"
---
...
Si l'UTMB Index n'avait qu'une valeur indicative, une baisse silencieuse resterait anecdotique. Mais ce score conditionne directement l'accès à certaines [courses](https://www.altitude-trail.fr/articles/a-71-ans-michel-poletti-traverse-la-france-a-pied-entre-ses-courses-utmb). Dans l'écosystème UTMB World Series, il est lié au système des Running Stones, la monnaie de qualification pour les grandes épreuves du circuit : l'UTMB, la CCC, la TDS, l'OCC.
...
![Dense crowd of trail runners at UTMB World Series race start line in mountain village at dawn, race bibs clearly visible](/articles/utmb-index-pourquoi-votre-score-a-baisse-alors-que-vous-n-y-etes-pour-rien-2.jpg)
